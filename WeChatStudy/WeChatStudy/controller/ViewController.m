...
- (void)viewDidLoad {
    ...
    self.dataArray = @[@"微信登录",@"拉起小程序",@"小程序类型分享",@"图像识别"];
...
/** 图像识别 */
- (void)sendImageSearchRequest{
    UIStoryboard *mainBD = [UIStoryboard storyboardWithName:@"Main" bundle:[NSBundle mainBundle]];
    UIViewController *imageSearchCtl = [mainBD instantiateViewControllerWithIdentifier:@"searchImageCtlIdentifier"];
    [self.navigationController pushViewController:imageSearchCtl animated:YES];
}
